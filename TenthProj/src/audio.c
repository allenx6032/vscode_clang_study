...
int laudioLoadWaveFromMemory( lua_State* L ) {
	...
	uluaPushWave( L, LoadWaveFromMemory( fileType, ( const unsigned char *)buffer->data, buffer->size ) );
...
int laudioLoadMusicStreamFromMemory( lua_State* L ) {
	...
	uluaPushMusic( L, LoadMusicStreamFromMemory( fileType, ( const unsigned char *)buffer->data, buffer->size ) );
