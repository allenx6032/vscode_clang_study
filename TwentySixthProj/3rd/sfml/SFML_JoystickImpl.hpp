...
struct JoystickState
{
    ...
    #include <sfml/SFML_Win32_JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_LINUX)

    #include <sfml/SFML_Unix_JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_FREEBSD)

    #include <sfml/SFML_FreeBSD_JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_OPENBSD)

    #include <sfml/SFML_OpenBSD_JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_MACOS)

    #include <sfml/SFML_OSX_JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_IOS)

    #include <sfml/SFML_iOS_JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_ANDROID)

    #include <sfml/SFML_Android_JoystickImpl.hpp>
