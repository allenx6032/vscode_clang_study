...
// Headers
////////////////////////////////////////////////////////////
#include <sfml/SFML_GlContext.hpp>
#include <sfml/SFML_Context.hpp>
#include <sfml/SFML_ThreadLocalPtr.hpp>
#include <sfml/SFML_Mutex.hpp>
#include <sfml/SFML_Lock.hpp>
...
#include <cassert>
        ...
        #include <sfml/SFML_Win32_WglContext.hpp>
        typedef sf::priv::WglContext ContextType;

    #elif defined(SFML_SYSTEM_LINUX) || defined(SFML_SYSTEM_FREEBSD) || defined(SFML_SYSTEM_OPENBSD)

        #include <sfml/SFML_Unix_GlxContext.hpp>
        typedef sf::priv::GlxContext ContextType;

    #elif defined(SFML_SYSTEM_MACOS)

        #include <sfml/SFML_OSX_SFContext.hpp>
        ...
        #include <sfml/SFML_iOS_EaglContext.hpp>
        typedef sf::priv::EaglContext ContextType;

    #else

        #include <sfml/SFML_EglContext.hpp>
