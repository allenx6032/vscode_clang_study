...
protected:
    ...
    static void vertexCB(void* vertexData, void* data) {
        static_cast<GrTess*>(data)->vertex(static_cast<int>(reinterpret_cast<long long>(vertexData)));
    }
    ...
    static void combineCB(GLdouble coords[3], void* vertexData[4],
        ...
        int vertexIndex[4];
        vertexIndex[0] = static_cast<int>(reinterpret_cast<long long>(vertexData[0]));
        vertexIndex[1] = static_cast<int>(reinterpret_cast<long long>(vertexData[1]));
        vertexIndex[2] = static_cast<int>(reinterpret_cast<long long>(vertexData[2]));
        vertexIndex[3] = static_cast<int>(reinterpret_cast<long long>(vertexData[3]));
