...
#include <windows.h>
#include <cstring>
#include "agg/agg_platform_support.h"
#include "agg/agg_charconvert.h"
#include "agg/agg_win32_bmp.h"
#include "agg/agg_color_conv.h"
#include "agg/agg_color_conv_rgb8.h"
#include "agg/agg_color_conv_rgb16.h"
...
namespace agg
{
    ...
    void platform_support::caption(const char* cap)
    {
        ...
        {
            SetWindowText(m_specific->m_hwnd, 
            #if defined(__UNICODE__)
            utf8_to_wchar(m_caption)
            #elif
            m_caption
            #endif
            );
...
*/
    ...
    bool platform_support::init(unsigned width, unsigned height, unsigned flags)
    {
        ...
        m_specific->m_hwnd = ::CreateWindow(
                                            #if defined(__UNICODE__)
                                            L"AGGAppClass",
                                            utf8_to_wchar(m_caption), 
                                            #elif
        ...
        ::SetWindowLongPtr(m_specific->m_hwnd, GWLP_USERDATA, (LONG)(size_t)this);
