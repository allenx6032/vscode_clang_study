...
#include <sfml/SFML_OpenGL.hpp>
#include <sfml/SFML_Clipboard.hpp>
#include <sfml/SFML_Cursor.hpp>
#include <sfml/SFML_Event.hpp>
...
bool UpdateFontTexture() {
    ...
    // texture.update(static_cast<sf::Uint8 *>(pixels));
    char * pixel_ =  reinterpret_cast<char*>(pixels);
    // texture.update((static_cast<char*>(pixels));
    texture.update(pixel_);
