...
bool cmd_save_font() {
  ...
  ofn.lpstrFilter = L"HGE Font Files\0*.fnt\0All Files\0*.*\0\0";
  ofn.lpstrFile = utf8_to_wchar(szFile);
  ...
  if (!fp) {
    ...
    MessageBox(nullptr, utf8_to_wchar(szTemp), L"Can't write to file",
