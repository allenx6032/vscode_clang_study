...
void E2dEngine::initialize(uint32 window_width, uint32 window_height)
{
   ...
   // slider->setRotate(PI / 2);
    ...
    auto txt = UIFactory::instance()->createLabel("text", L"daAFKsbBgf123", Vec2(0, 5), Vec2(200, 60), mUIRoot);
    ...
    auto txt2 = UIFactory::instance()->createLabel("text2", L"daAFKsbBgf123", Vec2(300, 100), Vec2(100, 60), mUIRoot);
    txt2->setItalic(true);
