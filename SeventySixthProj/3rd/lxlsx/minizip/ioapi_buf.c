   ...
   uLong size;
{
    ...
    while (bytesLeftToRead > 0)
    {
        ...
        {
            bytesToCopy = fmin(bytesLeftToRead, (streamio->readBufferLength - streamio->readBufferPos));
   ...
   uLong size;
{
    ...
    while (bytesLeftToWrite > 0)
    {
        bytesToCopy = fmin(bytesLeftToWrite, (IOBUF_BUFFERSIZE - fmin(streamio->writeBufferLength, streamio->writeBufferPos)));
