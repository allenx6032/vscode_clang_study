...
static int io_init(lua_State *L) {
    ...
    ev_io_init(w, (void (*)(struct ev_loop *, ev_io *, int))watcher_cb, fd, revents);
    return 0;
}
...
static int timer_init(lua_State *L) {
    ...
    ev_timer_init(w, (void (*)(struct ev_loop*, struct ev_timer*, int))watcher_cb, after, repeat);
    return 0;
}
...
static int signal_init(lua_State *L) {
    ...
    ev_signal_init(w, (void (*)(struct ev_loop*, struct ev_signal*, int))watcher_cb, signum);
    return 0;
}
...
static int prepare_init(lua_State *L) {
    ...
    ev_prepare_init(w, (void (*)(struct ev_loop*, struct ev_prepare*, int))watcher_cb);
    return 0;
}
...
static int check_init(lua_State *L) {
    ...
    ev_check_init(w, (void (*)(struct ev_loop*, struct ev_check*, int))watcher_cb);
    return 0;
}
...
static int idle_init(lua_State *L) {
    ...
    ev_idle_init(w, (void (*)(struct ev_loop*, struct ev_idle*, int))watcher_cb);
    return 0;
}
