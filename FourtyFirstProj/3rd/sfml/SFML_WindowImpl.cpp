...
// Headers
////////////////////////////////////////////////////////////
#include <sfml/SFML_WindowImpl.hpp>
#include <sfml/SFML_Event.hpp>
#include <sfml/SFML_JoystickManager.hpp>
#include <sfml/SFML_SensorManager.hpp>
#include <sfml/SFML_Sleep.hpp>
#include <algorithm>
#include <cmath>

#if defined(SFML_SYSTEM_WINDOWS)

    #include <sfml/SFML_Win32_WindowImplWin32.hpp>
    typedef sf::priv::WindowImplWin32 WindowImplType;

#elif defined(SFML_SYSTEM_LINUX) || defined(SFML_SYSTEM_FREEBSD) || defined(SFML_SYSTEM_OPENBSD)

    #include <sfml/SFML_Unix_WindowImplX11.hpp>
    typedef sf::priv::WindowImplX11 WindowImplType;

#elif defined(SFML_SYSTEM_MACOS)

    #include <sfml/SFML_OSX_WindowImplCocoa.hpp>
    typedef sf::priv::WindowImplCocoa WindowImplType;

#elif defined(SFML_SYSTEM_IOS)

    #include <sfml/SFML_iOS_WindowImplUIKit.hpp>
    typedef sf::priv::WindowImplUIKit WindowImplType;

#elif defined(SFML_SYSTEM_ANDROID)

    #include <sfml/SFML_Android_WindowImplAndroid.hpp>
