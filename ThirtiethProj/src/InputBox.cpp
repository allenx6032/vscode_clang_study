...
namespace sen {
    InputBox::InputBox(const sf::String &placeholder)
        ...
        InputController::setValidateFunction([](const sf::String &string) -> bool { return string.getSize() <= 30; });
    }
    ...
    const sf::String &InputBox::getString() const { return m_message.getString(); }
    InputBox::~InputBox() { InputController::unbindText(); }
} // namespace sen
