                                                ...
                                                glyph_rendering ren_type)
    {
        if(m_dc)
        {
            ...
            else
            {
                ...
                int wideLen = MultiByteToWideChar(CP_UTF8, 0, m_typeface, -1, nullptr, 0);
                wchar_t* m_typeface_w = new wchar_t[wideLen];
                MultiByteToWideChar(CP_UTF8, 0, m_typeface, -1, m_typeface_w, wideLen);
