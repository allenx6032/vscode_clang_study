...
lua_State* L;
const char *fileName1 = "hello.lua";
const char *fileName2 = "sample.lua";
const char *fileName3 = "interface.lua";
...
int main( )
{
	...
	//	加载lua文件
	int nRet = luaL_loadfile(L, fileName1);
	if ( nRet )
	{
