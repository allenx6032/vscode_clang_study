...
int lua_LoadSound(lua_State *L) {
    ...
    Sound *pSound = (Sound *)lua_newuserdata(L, sizeof(Sound));
    *pSound = sound;
...
int lua_LoadMusicStream(lua_State *L) {
    ...
    Music *pMusic = (Music *)lua_newuserdata(L, sizeof(Music));
    *pMusic = music;
...
int lua_LoadWave(lua_State *L) {
    ...
    Wave *pWave = (Wave *)lua_newuserdata(L, sizeof(Wave));
    *pWave = wave;
...
int lua_LoadSoundAlias(lua_State *L) {
    ...
    Sound *pAlias = (Sound *)lua_newuserdata(L, sizeof(Sound));
    *pAlias = alias;
    luaL_setmetatable(L, "Sound");
    return 1;
}
...
int lua_WaveCopy(lua_State *L) {
    ...
    Wave *pCopiedWave = (Wave *)lua_newuserdata(L, sizeof(Wave));
...
int lua_LoadAudioStream(lua_State *L) {
    ...
    AudioStream *pStream = (AudioStream *)lua_newuserdata(L, sizeof(AudioStream));
    *pStream = stream;
