...
namespace ouzel::graphics::d3d11
{
    namespace
    {
        ...
        constexpr D3D10_TEXTURECUBE_FACE getCubeFace(CubeFace face)
        {
            switch (face)
            {
                ...
                case CubeFace::positiveX: return D3D10_TEXTURECUBE_FACE_POSITIVE_X;
                case CubeFace::negativeX: return D3D10_TEXTURECUBE_FACE_NEGATIVE_X;
                case CubeFace::positiveY: return D3D10_TEXTURECUBE_FACE_POSITIVE_Y;
                case CubeFace::negativeY: return D3D10_TEXTURECUBE_FACE_NEGATIVE_Y;
                case CubeFace::positiveZ: return D3D10_TEXTURECUBE_FACE_POSITIVE_Z;
                case CubeFace::negativeZ: return D3D10_TEXTURECUBE_FACE_NEGATIVE_Z;
