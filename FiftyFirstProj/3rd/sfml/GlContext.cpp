...
// Headers
////////////////////////////////////////////////////////////
#include <SFML/GlContext.hpp>
#include <SFML/Context.hpp>
#include <SFML/ThreadLocalPtr.hpp>
#include <SFML/Mutex.hpp>
#include <SFML/Lock.hpp>
...
#include <cassert>
        ...
        #include <SFML/EglContext.hpp>
        typedef sf::priv::EglContext ContextType;

    #else

        #include <SFML/WglContextWin32.hpp>
        ...
        #include <SFML/DRM/DRMContext.hpp>
        ...
        #include <SFML/GlxContextX11.hpp>
    ...
    #include <SFML/OSX/SFContext.hpp>
    typedef sf::priv::SFContext ContextType;

#elif defined(SFML_SYSTEM_IOS)

    #include <SFML/iOS/EaglContext.hpp>
