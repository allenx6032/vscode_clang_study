...
static RectangleR texShapesRec = { 0.0f, 0.0f, 1.0f, 1.0f };    // Texture source rectangle used on shapes drawing
...
void SetShapesTexture(Texture2D texture, RectangleR source)
{
    ...
    if ((texture.id == 0) || (source.width == 0) || (source.height == 0))
    {
        ...
        texShapesRec = (RectangleR){ 0.0f, 0.0f, 1.0f, 1.0f };
    }
    else
    {
        texShapes = texture;
...
RectangleR GetShapesTextureRectangle(void)
{
    return texShapesRec;
}
...
void DrawPixelV(Vector2 position, Color color)
{
    ...
    RectangleR shapeRect = GetShapesTextureRectangle();
...
{
    DrawRectanglePro((RectangleR){ position.x, position.y, size.x, size.y }, (Vector2){ 0.0f, 0.0f }, 0.0f, color);
}

// Draw a color-filled rectangle
void DrawRectangleRec(RectangleR rec, Color color)
{
    DrawRectanglePro(rec, (Vector2){ 0.0f, 0.0f }, 0.0f, color);
}

// Draw a color-filled rectangle with pro parameters
void DrawRectanglePro(RectangleR rec, Vector2 origin, float rotation, Color color)
{
    Vector2 topLeft = { 0 };
    Vector2 topRight = { 0 };
...
{
    DrawRectangleGradientEx((RectangleR){ (float)posX, (float)posY, (float)width, (float)height }, top, bottom, bottom, top);
}

// Draw a horizontal-gradient-filled rectangle
void DrawRectangleGradientH(int posX, int posY, int width, int height, Color left, Color right)
{
    DrawRectangleGradientEx((RectangleR){ (float)posX, (float)posY, (float)width, (float)height }, left, left, right, right);
}

// Draw a gradient-filled rectangle
void DrawRectangleGradientEx(RectangleR rec, Color topLeft, Color bottomLeft, Color topRight, Color bottomRight)
{
    rlSetTexture(GetShapesTexture().id);
    RectangleR shapeRect = GetShapesTextureRectangle();
...
void DrawRectangleLinesEx(RectangleR rec, float lineThick, Color color)
{
    ...
    RectangleR top = { rec.x, rec.y, rec.width, lineThick };
    RectangleR bottom = { rec.x, rec.y - lineThick + rec.height, rec.width, lineThick };
    RectangleR left = { rec.x, rec.y + lineThick, lineThick, rec.height - lineThick*2.0f };
    RectangleR right = { rec.x - lineThick + rec.width, rec.y + lineThick, lineThick, rec.height - lineThick*2.0f };
...
void DrawRectangleRounded(RectangleR rec, float roundness, int segments, Color color)
{
...
void DrawRectangleRoundedLines(RectangleR rec, float roundness, int segments, Color color)
{
    DrawRectangleRoundedLinesEx(rec, roundness, segments, 1.0f, color);
}

// Draw rectangle with rounded edges outline
void DrawRectangleRoundedLinesEx(RectangleR rec, float roundness, int segments, float lineThick, Color color)
{
    ...
    if (roundness <= 0.0f)
    {
        DrawRectangleLinesEx((RectangleR){rec.x-lineThick, rec.y-lineThick, rec.width+2*lineThick, rec.height+2*lineThick}, lineThick, color);
        return;
    }
...
bool CheckCollisionPointRec(Vector2 point, RectangleR rec)
{
...
bool CheckCollisionRecs(RectangleR rec1, RectangleR rec2)
{
    bool collision = false;
...
bool CheckCollisionCircleRec(Vector2 center, float radius, RectangleR rec)
{
    bool collision = false;
...
RectangleR GetCollisionRec(RectangleR rec1, RectangleR rec2)
{
    RectangleR overlap = { 0 };
