...
int lua_SetShapesTexture(lua_State *L) {
    ...
    RectangleR source = get_rectangle_from_table(L, 2);
...
int lua_GetShapesTextureRectangle(lua_State *L) {
    RectangleR rect = GetShapesTextureRectangle();
...
int lua_DrawRectangleRec(lua_State *L) {
    RectangleR rec = get_rectangle_from_table(L, 1);
    Color color = get_color_from_table(L, 2);
...
int lua_CheckCollisionRecs(lua_State *L) {
    RectangleR rec1 = get_rectangle_from_table(L, 1);
    RectangleR rec2 = get_rectangle_from_table(L, 2);
...
int lua_CheckCollisionCircleRec(lua_State *L) {
    Vector2 center = get_vector2_from_table(L, 1);
    float radius = luaL_checknumber(L, 2);
    RectangleR rec = get_rectangle_from_table(L, 3);
...
int lua_CheckCollisionPointRec(lua_State *L) {
    ...
    RectangleR rec = get_rectangle_from_table(L, 2);
...
int lua_GetCollisionRec(lua_State *L) {
    RectangleR rec1 = get_rectangle_from_table(L, 1);
    RectangleR rec2 = get_rectangle_from_table(L, 2);
    RectangleR collisionRec = GetCollisionRec(rec1, rec2);
