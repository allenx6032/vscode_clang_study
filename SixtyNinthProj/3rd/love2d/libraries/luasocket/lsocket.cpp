...
#include "libraries/luasocket/mime.h"
}
...
{
	#include "libraries/luasocket/socket.lua.h"
	return 1;
}

int __open_luasocket_ftp(lua_State * L)
{
	#include "libraries/luasocket/ftp.lua.h"
	return 1;
}

int __open_luasocket_http(lua_State * L)
{
	#include "libraries/luasocket/http.lua.h"
	return 1;
}

int __open_luasocket_ltn12(lua_State * L)
{
	#include "libraries/luasocket/ltn12.lua.h"
	return 1;
}

int __open_luasocket_mime(lua_State * L)
{
	#include "libraries/luasocket/mime.lua.h"
	return 1;
}

int __open_luasocket_smtp(lua_State * L)
{
	#include "libraries/luasocket/smtp.lua.h"
	return 1;
}

int __open_luasocket_tp(lua_State * L)
{
	#include "libraries/luasocket/tp.lua.h"
	return 1;
}

int __open_luasocket_url(lua_State * L)
{
	#include "libraries/luasocket/url.lua.h"
	return 1;
}

int __open_luasocket_headers(lua_State * L)
{
	#include "libraries/luasocket/headers.lua.h"
	return 1;
}

int __open_luasocket_mbox(lua_State * L)
{
	#include "libraries/luasocket/mbox.lua.h"
	return 1;
}
