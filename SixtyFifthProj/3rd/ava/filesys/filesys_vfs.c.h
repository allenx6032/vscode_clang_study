...
//#include "../struct/struct_map.c.h"
//#include "../struct/struct_hash.c.h"
//#include "../struct/struct_cmp.c.h"
...
int main() {
    ...
    puts( vfs_find( "filesys_vfs.c.h") );
    puts( vfs_find( "non_existing_file.c.h" ) );
