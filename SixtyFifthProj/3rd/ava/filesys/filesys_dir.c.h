...
#ifdef DIR_C
#pragma once
#include "ava/engine.h" // detect, realloc
//#include "ava/detect/detect_memory.c.h"
...
int main() {
    ...
    system("echo>_test_temp.c.h");
    system("echo>_test_modf.c.h");
    system("echo>_test_keep.c.h");
    char *dir1 = dir_ls2( "./*.c.h" );
    printf( "dir1 {\n%s}\n", dir1 );

    // give 1s spare time for modft to change
    Sleep( 1500 );

    system("del _test_temp.c.h"); /* test delete */
    system("echo>>_test_modf.c.h"); /* test modft */
    /*system("type _test_keep.c.h");*/ /* no modif test */
