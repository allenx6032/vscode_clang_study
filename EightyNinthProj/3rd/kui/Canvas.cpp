#include "UIDefine.h"
#include "Canvas.h"
#include "graphics/skia/SkiaGraphics.h"
#include "graphics/gdiplus/GdiPlusGraphics.h"
#include "graphics/gdi/GdiGraphics.h"
#include "Size.h"
...
public:
    // 假设_pGraphics和_graphicsType已正确声明
    Graphics* _pGraphics;       // 替换SomeType为实际类型
    ak::GraphicsType _graphicsType;
}; // 类定义结束需加分号
