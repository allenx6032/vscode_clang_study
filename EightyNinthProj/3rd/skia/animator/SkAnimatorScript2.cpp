...
// 添加类型转换辅助函数
// static SkOperand2::OpType ConvertDisplayType(SkDisplayTypes displayType) {
//     switch (displayType) {
//         case SkType_Int: return kInt_SkOperand2Type;
//         case SkType_Float: return kScalar_SkOperand2Type;
//         case SkType_String: return kString_SkOperand2Type;
//         case SkType_Unknown: return kUnknown_SkOperand2Type;
//         // 添加其他类型的映射
//         default: return kUnknown_SkOperand2Type;
//     }
// }

// static const SkScriptNAnswer2 scriptTests[]  = {
//     {    "alpha+alpha", ConvertDisplayType(SkType_String), 0, 0, "abcabc" },
//     {    "0 ? Math.sin(0) : 1", ConvertDisplayType(SkType_Int), 1 },
//     {    "intArray[4]", ConvertDisplayType(SkType_Unknown) },
//     {    "emptyArray[4]", ConvertDisplayType(SkType_Unknown) },
//     {    "idx", ConvertDisplayType(SkType_Int), 2 },
//     {    "intArray.length", ConvertDisplayType(SkType_Int), 3 },
//     {    "intArray.values[0]", ConvertDisplayType(SkType_Int), 1 },
//     {    "intArray[0]", ConvertDisplayType(SkType_Int), 1 },
//     {    "idx.value", ConvertDisplayType(SkType_Int), 2 },
//     {    "alpha.value", ConvertDisplayType(SkType_String), 0, 0, "abc" },
//     {    "alpha", ConvertDisplayType(SkType_String), 0, 0, "abc" },
//     {    "alpha.value+alpha.value", ConvertDisplayType(SkType_String), 0, 0, "abcabc" },
//     {    "alpha+idx", ConvertDisplayType(SkType_String), 0, 0, "abc2" },
//     {    "idx+alpha", ConvertDisplayType(SkType_String), 0, 0, "2abc" },
//     {    "intArray[idx]", ConvertDisplayType(SkType_Int), 6 },
//     {    "alpha.slice(1,2)", ConvertDisplayType(SkType_String), 0, 0, "b" },
//     {    "alpha.value.slice(1,2)", ConvertDisplayType(SkType_String), 0, 0, "b" },
//     {    "Math.sin(0)", ConvertDisplayType(SkType_Float), 0, SkIntToScalar(0) },
//     {    "testRect.left+2", ConvertDisplayType(SkType_Float), 0, SkIntToScalar(3) },
//     {    "0 ? intArray[0] : 1", ConvertDisplayType(SkType_Int), 1 },
//     {    "0 ? intArray.values[0] : 1", ConvertDisplayType(SkType_Int), 1 },
//     {    "0 ? idx : 1", ConvertDisplayType(SkType_Int), 1 },
//     {    "0 ? idx.value : 1", ConvertDisplayType(SkType_Int), 1 },
//     {    "0 ? alpha.slice(1,2) : 1", ConvertDisplayType(SkType_Int), 1 },
//     {    "0 ? alpha.value.slice(1,2) : 1", ConvertDisplayType(SkType_Int), 1 },
//     { "idy", ConvertDisplayType(SkType_Int), 3 }
// };
