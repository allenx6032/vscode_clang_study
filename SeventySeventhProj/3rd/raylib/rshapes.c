...
RectangleR texShapesRec = { 0.0f, 0.0f, 1.0f, 1.0f };    // Texture source rectangle used on shapes drawing
...
{
    DrawRectangleGradientEx((RectangleR){ (float)posX, (float)posY, (float)width, (float)height }, color1, color2, color2, color1);
}
...
{
    DrawRectangleGradientEx((RectangleR){ (float)posX, (float)posY, (float)width, (float)height }, color1, color1, color2, color2);
}

// Draw a gradient-filled rectangle
// NOTE: Colors refer to corners, starting at top-lef corner and counter-clockwise
void DrawRectangleGradientEx(RectangleR rec, Color col1, Color col2, Color col3, Color col4)
{
    rlSetTexture(texShapes.id);
...
void DrawRectangleRoundedLines(RectangleR rec, float roundness, int segments, float lineThick, Color color)
{
