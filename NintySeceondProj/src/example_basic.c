...
luaA_function_declare(power, float, float, int);
luaA_function_declare(fib, int, int);
// luaA_function_declare(hello_world, void, void);
// luaA_function_declare(hello_repeat, void, int);
// luaA_function_declare(hello_person, void, const char*);
// luaA_function_declare(hello_subcount, int, const char*);
...
int main(int argc, char **argv) {
  ...
  luaA_function_register(L, power, float, float, int);
  ...
  // luaA_function(L, hello_world, int);
  // luaA_function(L, hello_repeat, int, int);
  // luaA_function(L, hello_person, int, const char*);
  // luaA_function(L, hello_subcount, int, const char*);
  // luaA_function_register(L, hello_world, void, void);
  // luaA_function_register(L, hello_repeat, void, int);
  // luaA_function_register(L, hello_person, void, const char*);
  // luaA_function_register(L, hello_subcount, int, const char*);
    //
  lua_register(L, "C", C);
    //
  luaL_dostring(L,
