...
#include <SFML/JoystickImplWin32.hpp>

#elif defined(SFML_SYSTEM_LINUX)

#include <SFML/JoystickImplX11.hpp>

#elif defined(SFML_SYSTEM_FREEBSD)

#include <SFML/FreeBSD/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_OPENBSD)

#include <SFML/OpenBSD/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_NETBSD)

#include <SFML/NetBSD/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_MACOS)

#include <SFML/macOS/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_IOS)

#include <SFML/iOS/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_ANDROID)

#include <SFML/Android/JoystickImpl.hpp>
