...
#include "csol/baize.h"
#include "csol/command.h"
#include "csol/luautil.h"
#include "csol/spritesheet.h"
#include "csol/trace.h"
#include "csol/undo.h"
...
// Check C standard version
    ...
    #else
        fprintf(stderr, "C version: C99 or non-standard compiler\n");
    #endif
    fprintf(stderr, "sizeof(int) == %llu\n", sizeof(int));
    fprintf(stderr, "sizeof(float) == %llu\n", sizeof(float));
    fprintf(stderr, "sizeof(void*) == %llu\n", sizeof(void*));
    fprintf(stderr, "sizeof(size_t) == %llu\n", sizeof(size_t));
    // fprintf(stderr, "sizeof(Array) == %lu\n", sizeof(struct Array));
    // fprintf(stderr, "sizeof(Card) == %lu\n", sizeof(struct Card));
    fprintf(stderr, "sizeof(Pile) == %llu\n", sizeof(struct Pile));
    fprintf(stderr, "sizeof(Baize) == %llu\n", sizeof(struct Baize));
