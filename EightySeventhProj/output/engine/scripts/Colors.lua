...
F_Colors = {
	...
	lightGridColor = Vector4:new(0.8, 0.8, 0.8, 0.05),
	mainGridColor = Vector4:new(0.8, 0.8, 0.8, 0.1),
	popGridColor = Vector4:new(0.8, 0.8, 0.8, 0.2),
	...
	shapesScrollingBg = Vector4:new(0.38, 0.38, 0.47, 0.4),
	shapeBg = Vector4:new(0.16, 0.16, 0.18, 1.0),
	jointsScrollingBg = Vector4:new(0.38, 0.38, 0.47, 0.4),
	jointBg = Vector4:new(0.16, 0.16, 0.18, 1.0),
	jointConnection = Vector4:new(1.0, 1.0, 0.27, 1.0),
	-- Colliders --
