...
#include "freetype/ft2_otvmod.h"
#include "freetype/ft2_otvalid.h"
#include "freetype/ft2_otvcommn.h"
...
#define FT_COMPONENT  trace_otvmodule
                ...
                FT_Bytes          *ot_jstf )
  {
    ...
    {
      FT_TRACE1(( "freetype/ft2_otv_validate: Invalid glyphs index (0x0000FFFF - 0x%08x) ",
                  face->num_glyphs ));
